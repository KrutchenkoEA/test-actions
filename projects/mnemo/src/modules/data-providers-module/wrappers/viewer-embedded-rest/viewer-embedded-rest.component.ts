...
import { AbstractAppService, ViewerCoreModule, ViewerCoreRestDirective, ViewerService } from '../../../pure-modules';
import { MnemoChartModule, ViewerToolbarComponent } from '../../../additional-modules';

@DecorateUntilDestroy()
@Component({
  selector: 'tl-viewer-embedded-rest',
  templateUrl: './viewer-embedded-rest.component.html',
  styleUrl: './viewer-embedded-rest.component.scss',
...
export class ViewerEmbeddedRestComponent extends ViewerCoreRestDirective implements OnInit, AfterViewInit, OnDestroy {
